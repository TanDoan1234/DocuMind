...
- **Mô hình ngôn ngữ lớn (LLM):** 
  - **Tóm tắt văn bản:** Model [ViT5](https://huggingface.co/VietAI/vit5-base-vietnamese-summarization) cho việc tóm tắt nội dung tự động.
  - **Hỏi đáp AI:** Model ViT5 chuyên biệt cho việc trả lời câu hỏi dựa trên ngữ cảnh.
