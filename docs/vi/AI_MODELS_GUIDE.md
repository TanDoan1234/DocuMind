...
<div align="right">
  🌍 <b><a href="../en/AI_MODELS_GUIDE.md">English Version</a></b>
</div>
...
| **Tìm kiếm ngữ nghĩa** | Vietnamese-SBERT | Sentence Embedding |
...
Các mô hình này được sử dụng để trích xuất câu trả lời từ các đoạn tài liệu dựa trên câu hỏi của người dùng trong quy trình RAG (Retrieval-Augmented Generation).
...
### **Vietnamese-SBERT**
- **Vai trò:** Tìm kiếm ngữ nghĩa & Truy vấn (Retrieval).
- **Mô hình:** `keepitreal/vietnamese-sbert`
- **Chức năng:** Chuyển đổi các đoạn văn bản thành vector 768 chiều. Điều này cho phép DocuMind tìm thấy các phần liên quan nhất của tài liệu ngay cả khi câu hỏi của người dùng không sử dụng chính xác các từ ngữ có trong văn bản.
