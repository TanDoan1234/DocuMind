...
> **Alternative Registry:** Images available on both Docker Hub (`lfnovo/open_notebook:v1-latest-single`) and GitHub Container Registry (`ghcr.io/lfnovo/documind:v1-latest-single`).

## Prerequisites

- Docker installed (for local testing)
- API key from OpenAI, or another provider
- 5 minutes
