...
DocuMind uses SurrealDB for its database needs. 

---

## Default Configuration

DocuMind should work out of the box with SurrealDB as long as the environment variables are correctly setup. 


### DB running in the same docker compose as DocuMind (recommended)
...
### DB running in the host machine and DocuMind running in Docker
...
### DocuMind and Surreal are running on the same machine
