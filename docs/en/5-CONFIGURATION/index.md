...
Configuration is how you customize DocuMind for your specific setup. This section covers what you need to know.
...
1. **AI Provider** — Which LLM/embedding service you're using (OpenAI, Ollama, etc.)
...
You will only use .env if you are running DocuMind locally.
...
```
1. Open DocuMind in your browser
