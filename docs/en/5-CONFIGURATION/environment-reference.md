...
Comprehensive list of all environment variables available in DocuMind.
...
| `OPEN_NOTEBOOK_PASSWORD` | No | None | Password to protect DocuMind instance |
...
**Affects:**
- AI provider API calls (OpenAI, Google, Groq, etc.)
...
| `LANGCHAIN_PROJECT` | No | DocuMind | LangSmith project name |
