...
> - **[docker-compose-speaches.yml](../../examples/docker-compose-speaches.yml)** - Speaches + DocuMind
...
```yaml
# In your DocuMind docker-compose.yml
environment:
...
### DocuMind in Docker (macOS/Windows)

**STT Base URL:** `http://host.docker.internal:8969/v1`

### DocuMind in Docker (Linux)
...
# From inside DocuMind container
docker exec -it documind curl http://host.docker.internal:8969/v1/models
```
