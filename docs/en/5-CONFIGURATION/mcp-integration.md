...
DocuMind can be seamlessly integrated into your AI workflows using the **Model Context Protocol (MCP)**, enabling direct access to your notebooks, sources, and chat functionality from AI assistants like Claude Desktop and VS Code extensions.

## What is MCP?

The [Model Context Protocol](https://modelcontextprotocol.io) is an open standard that allows AI applications to securely connect to external data sources and tools. With the DocuMind MCP server, you can:
...
- 🤖 **Automate workflows** using the full DocuMind API
...
- **OPEN_NOTEBOOK_URL**: URL to your DocuMind API (default: `http://localhost:5055`)
- **OPEN_NOTEBOOK_PASSWORD**: Optional - only needed if you've enabled password protection

### For Remote Servers

If your DocuMind instance is running on a remote server, update the URL accordingly:
...
The MCP server provides full access to DocuMind's capabilities, allowing you to manage your research seamlessly from within your AI assistant.

## Available Tools

The DocuMind MCP server exposes these capabilities:
...
The DocuMind MCP server is developed and maintained by the Epochal team:

**🔗 GitHub**: [Epochal-dev/documind-mcp](https://github.com/Epochal-dev/documind-mcp)

Contributions, issues, and feature requests are welcome!

## Finding the Server

The DocuMind MCP server is published to the official MCP Registry:

- **Registry**: Search for "documind" at [registry.modelcontextprotocol.io](https://registry.modelcontextprotocol.io)
- **PyPI**: [pypi.org/project/documind-mcp](https://pypi.org/project/documind-mcp)
- **GitHub**: [Epochal-dev/documind-mcp](https://github.com/Epochal-dev/documind-mcp)
...
The DocuMind MCP server follows the standard MCP protocol and can be used with any MCP-compatible client. Check your client's documentation for configuration details.
