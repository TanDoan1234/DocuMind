...
Get DocuMind running with **Google, Groq, or other cloud providers**. Same simplicity as OpenAI, with more choices.
...
Create a new folder `documind` and add this file:
...
Open terminal in your `documind` folder:
...
## Step 3: Access DocuMind (instant)
...
3. Select your provider (e.g., Google, Groq, OpenRouter)
