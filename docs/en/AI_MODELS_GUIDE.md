...
<div align="right">
  🌍 <b><a href="../vi/AI_MODELS_GUIDE.md">Vietnamese Version</a></b>
</div>
...
| **Semantic Search** | Vietnamese-SBERT | Sentence Embedding |
...
These models are used to extract answers from document chunks based on user queries in a RAG (Retrieval-Augmented Generation) pipeline.
...
### **Vietnamese-SBERT**
- **Role:** Semantic Search & Retrieval.
- **Model:** `keepitreal/vietnamese-sbert`
- **Function:** Converts text chunks into 768-dimensional vectors. This allows DocuMind to find the most relevant parts of a document even if the user's question doesn't use the exact same words as the text.
