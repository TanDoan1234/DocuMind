...
DocuMind follows a three-tier architecture with clear separation of concerns:
...
**Esperanto Library**:
- Unified interface to 8+ LLM providers (OpenAI, Google, Groq, Ollama, Mistral, DeepSeek, xAI)
...
LangGraph is a state machine library that orchestrates multi-step AI workflows. DocuMind uses five core workflows:
