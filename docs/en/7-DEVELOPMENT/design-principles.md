...
This document outlines the core principles, vision, and design philosophy that guide DocuMind's development. All contributors should read and understand these principles before proposing changes or new features.

## 🎯 Project Vision

DocuMind aims to be a **privacy-focused, self-hosted alternative to Google's Notebook LM** that empowers users to:
...
**Example Decisions**:
- ✅ Support for 5 Core AI providers (OpenAI, Google AI, Ollama, ElevenLabs, Local)
